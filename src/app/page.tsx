...
export default function Home() {
  return (
    <main className="max-w-[1260px] mx-automin-h-screen flex gap-6 items-start">
      <aside className="min-h-screen sticky top-0 left-0 w-64  p-6 flex flex-col justify-between">
        <div className="flex flex-col">
          <Link
            href={"/"}
            className="flex items-center hover:bg-zinc-800 rounded-full gap-5 p-3 text-gray-300"
          >
